...
{
    public partial class President_ROBU_Mem : Form
    {
        public President_ROBU_Mem()
        {
            InitializeComponent();
        }
        ...
        {
            President_ROBU_Event eventROBU = new President_ROBU_Event();
            eventROBU.Show();
            this.Hide();
        }
...
Integrated Security=True;Encrypt=False"))
            {
                ...
                {
                    cmd.CommandText = @"
            INSERT INTO dbo.BracRobu_Member
        ...
        private void Remove_Mem_Click(object sender, EventArgs e)
        {
                  ...
                  Integrated Security=True;Encrypt=False"))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "DELETE FROM dbo.BracRobu_Member WHERE MemberID = @Id", con);
