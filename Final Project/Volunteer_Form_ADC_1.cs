...
{
    public partial class Volunteer_Form_ADC_1 : Form
    {
        public Volunteer_Form_ADC_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyADC1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO ADC_Event1_Volunteer
