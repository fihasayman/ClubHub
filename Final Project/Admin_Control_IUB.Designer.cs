...
{
    partial class Admin_Control_IUB
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Admin_Control_IUB));
            ...
            label2.Name = "label2";
            label2.Size = new Size(808, 43);
            label2.TabIndex = 85;
            label2.Text = "Presidents of Independent Marketer's Association";
            label2.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // panel1
            // 
            panel1.BackColor = Color.FromArgb(0, 53, 82);
            panel1.Controls.Add(IPC_Pre);
            panel1.Controls.Add(IHRS_Pre);
            panel1.Controls.Add(IMA_Pre);
            panel1.Controls.Add(IAA_Pre);
            ...
            // IPC_Pre
            // 
            IPC_Pre.BackColor = Color.FromArgb(0, 53, 82);
            IPC_Pre.Cursor = Cursors.Hand;
            IPC_Pre.FlatAppearance.BorderSize = 0;
            IPC_Pre.FlatStyle = FlatStyle.Flat;
            IPC_Pre.Font = new Font("Cambria", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            IPC_Pre.ForeColor = Color.FromArgb(222, 238, 246);
            IPC_Pre.Location = new Point(19, 289);
            IPC_Pre.Name = "IPC_Pre";
            IPC_Pre.Size = new Size(251, 63);
            IPC_Pre.TabIndex = 32;
            IPC_Pre.Text = "Independent Photography Club";
            IPC_Pre.UseVisualStyleBackColor = false;
            IPC_Pre.Click += IPC_Pre_Click;
            // 
            // IHRS_Pre
            // 
            IHRS_Pre.BackColor = Color.FromArgb(0, 53, 82);
            IHRS_Pre.Cursor = Cursors.Hand;
            IHRS_Pre.FlatAppearance.BorderSize = 0;
            IHRS_Pre.FlatStyle = FlatStyle.Flat;
            IHRS_Pre.Font = new Font("Cambria", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            IHRS_Pre.ForeColor = Color.FromArgb(222, 238, 246);
            IHRS_Pre.Location = new Point(19, 197);
            IHRS_Pre.Name = "IHRS_Pre";
            IHRS_Pre.Size = new Size(251, 63);
            IHRS_Pre.TabIndex = 30;
            IHRS_Pre.Text = "Independent Human Resource Society";
            IHRS_Pre.UseVisualStyleBackColor = false;
            IHRS_Pre.Click += IHRS_Pre_Click;
            // 
            // IMA_Pre
            // 
            IMA_Pre.BackColor = Color.FromArgb(0, 40, 66);
            IMA_Pre.FlatAppearance.BorderSize = 0;
            IMA_Pre.FlatStyle = FlatStyle.Flat;
            IMA_Pre.Font = new Font("Cambria", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            IMA_Pre.ForeColor = Color.FromArgb(222, 238, 246);
            IMA_Pre.Location = new Point(19, 13);
            IMA_Pre.Name = "IMA_Pre";
            IMA_Pre.Size = new Size(251, 63);
            IMA_Pre.TabIndex = 27;
            IMA_Pre.Text = "Independent Marketer's Association";
            IMA_Pre.UseVisualStyleBackColor = false;
            // 
            // IAA_Pre
            // 
            IAA_Pre.BackColor = Color.FromArgb(0, 53, 82);
            IAA_Pre.Cursor = Cursors.Hand;
            IAA_Pre.FlatAppearance.BorderSize = 0;
            IAA_Pre.FlatStyle = FlatStyle.Flat;
            IAA_Pre.Font = new Font("Cambria", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            IAA_Pre.ForeColor = Color.FromArgb(222, 238, 246);
            IAA_Pre.Location = new Point(19, 105);
            IAA_Pre.Name = "IAA_Pre";
            IAA_Pre.Size = new Size(251, 63);
            IAA_Pre.TabIndex = 28;
            IAA_Pre.Text = "Independent Accounting's Association";
            IAA_Pre.UseVisualStyleBackColor = false;
            IAA_Pre.Click += IAA_Pre_Click;
            // 
            // Logout
            // 
            ...
            label4.Name = "label4";
            label4.Size = new Size(263, 27);
            label4.TabIndex = 72;
            label4.Text = "Manage Presidents of IUB";
            ...
            Name = "Admin_Control_IUB";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Admin_Control_IUB";
        ...
        private Button IPC_Pre;
        private Button IHRS_Pre;
        private Button IMA_Pre;
        private Button IAA_Pre;
