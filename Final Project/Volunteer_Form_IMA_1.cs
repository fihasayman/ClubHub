...
{
    public partial class Volunteer_Form_IMA_1 : Form
    {
        public Volunteer_Form_IMA_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyIMA1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO IMA_Event1_Volunteer
