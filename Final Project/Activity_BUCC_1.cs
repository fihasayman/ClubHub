...
{
    public partial class Activity_BUCC_1 : Form
    {
        public Activity_BUCC_1()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_BUCC_1 volunteer_BUCC1 = new Volunteer_BUCC_1();
            volunteer_BUCC1.Show();
            this.Hide();
        }

        private void Go_Back_Click(object sender, EventArgs e)
        {
            President_BUCC_Event president_BUCC_Event = new President_BUCC_Event();
            president_BUCC_Event.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM BUCC_Event1_Registration", con);
