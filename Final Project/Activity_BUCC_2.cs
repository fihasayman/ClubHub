...
{
    public partial class Activity_BUCC_2 : Form
    {
        public Activity_BUCC_2()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_BUCC_2 volunteer_BUCC2 = new Volunteer_BUCC_2();
            volunteer_BUCC2.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM BUCC_Event2_Registration", con);
