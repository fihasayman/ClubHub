...
{
    public partial class Volunteer_Form_BUAC_1 : Form
    {
        public Volunteer_Form_BUAC_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyBUAC1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO BUAC_Event1_Volunteer
