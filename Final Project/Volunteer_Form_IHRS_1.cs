...
{
    public partial class Volunteer_Form_IHRS_1 : Form
    {
        public Volunteer_Form_IHRS_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyIHRS1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO IHRS_Event1_Volunteer
