...
{
    public partial class Registration_Form_IMA_2 : Form
    {
        public Registration_Form_IMA_2()
        {
            InitializeComponent();
        }
        ...
        private void RegistrationIAM2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
                        INSERT INTO IMA_Event2_Registration
