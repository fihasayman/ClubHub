...
{
    public partial class President_PHSC_Mem : Form
    {
        public President_PHSC_Mem()
        {
            InitializeComponent();
        }
        ...
        {
            President_PHSC_App applicant = new President_PHSC_App();
            applicant.Show();
            this.Hide();
        }
        ...
        {
            President_PHSC_Event Event = new President_PHSC_Event();
            Event.Show();
            this.Hide();
        }
      ...
      Integrated Security=True;Encrypt=False"))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "DELETE FROM dbo.NSUPHSCMember WHERE MemberID = @Id", con);
