...
{
    public partial class President_NCEC_App : Form
    {
        public President_NCEC_App()
        {
            InitializeComponent();
        }
        ...
        {
            President_CEC_Mem president_CEC_Mem = new President_CEC_Mem();
            president_CEC_Mem.Show();
            this.Hide();
        }
