...
{
    public partial class Activity_BUAC_3 : Form
    {
        public Activity_BUAC_3()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_BUAC_3 volunteer_BUAC_3 = new Volunteer_BUAC_3();
            volunteer_BUAC_3.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM BUAC_Event3_Registration", con);
