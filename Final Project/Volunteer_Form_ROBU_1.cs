...
{
    public partial class Volunteer_Form_ROBU_1 : Form
    {
        public Volunteer_Form_ROBU_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyROBU1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO ROBU_Event1_Volunteer
