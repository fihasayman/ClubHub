...
{
    public partial class Activity_NPHSC_2 : Form
    {
        public Activity_NPHSC_2()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_PHSC_2 volunteer_PHSC_2 = new Volunteer_PHSC_2();
            volunteer_PHSC_2.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM NPHSC_Event2_Registration", con);
