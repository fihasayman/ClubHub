...
{
    public partial class Volunteer_Form_NYES_3 : Form
    {
        public Volunteer_Form_NYES_3()
        {
            InitializeComponent();
        }
        ...
        private void ApplyNYES3_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO NYES_Event3_Volunteer
