...
{
    public partial class President_BUCC_Mem : Form
    {
        public President_BUCC_Mem()
        {
            InitializeComponent();
        }
        ...
        {
            President_BUCC_Event Event = new President_BUCC_Event();
            Event.Show();
            this.Hide();
        }
      ...
      Integrated Security=True;Encrypt=False"))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "DELETE FROM dbo.BUCC_Member WHERE MemberID = @Id", con);
