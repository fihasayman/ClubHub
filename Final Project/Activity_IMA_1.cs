...
{
    public partial class Activity_IMA_1 : Form
    {
        public Activity_IMA_1()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_IMA_1 volunteer_IMA_1 = new Volunteer_IMA_1();
            volunteer_IMA_1.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM IMA_Event1_Registration", con);
