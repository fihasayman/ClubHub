...
{
    public partial class Registration_Form_PHSC_1 : Form
    {
        public Registration_Form_PHSC_1()
        {
            InitializeComponent();
        }
        ...
        private void RegistrationPHSC1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
                        INSERT INTO PHSC_Event1_Registration
