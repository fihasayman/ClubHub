...
{
    public partial class Activity_NCEC_2 : Form
    {
        public Activity_NCEC_2()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_NCEC_2 volunteer_NCEC_2 = new Volunteer_NCEC_2();
            volunteer_NCEC_2.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM NCEC_Event2_Registration", con);
