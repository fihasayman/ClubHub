...
{
    public partial class President_ABC_Mem : Form
    {
        public President_ABC_Mem()
        {
            InitializeComponent();
        }
      ...
      Integrated Security=True;Encrypt=False"))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "DELETE FROM dbo.ABC_Member WHERE MemberID = @Id", con);
