...
{
    public partial class Activity_IHRS_3 : Form
    {
        public Activity_IHRS_3()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_IHRS_3 volunteer_IHRS_3 = new Volunteer_IHRS_3();
            volunteer_IHRS_3.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM IHRS_Event3_Registration", con);
