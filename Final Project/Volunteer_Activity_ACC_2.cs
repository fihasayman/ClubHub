...
{
    public partial class Volunteer_Activity_ACC_2 : Form
    {
        public Volunteer_Activity_ACC_2()
        {
            InitializeComponent();
        }
        ...
        {
            Activity_ACC_2 activity_ACC2 = new Activity_ACC_2();
            activity_ACC2.Show();
            this.Hide();
        }
