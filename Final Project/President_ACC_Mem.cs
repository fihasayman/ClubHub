...
FROM ACC_Member";
        ...
        private void Update_Mem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("First Name, Email, Pasword and Phone are required.");
                return;
            }
      ...
      Integrated Security=True;Encrypt=False"))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "DELETE FROM dbo.ACC_Member WHERE MemberID = @Id", con);
