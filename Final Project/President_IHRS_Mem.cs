...
{
    public partial class President_IHRS_Mem : Form
    {
        public President_IHRS_Mem()
        {
            InitializeComponent();
        }
        ...
        private void Applicant_IHRS_Click(object sender, EventArgs e)
        {
            President_IHRS_App applicant = new President_IHRS_App();
            applicant.Show();
            this.Hide();
        }

        private void Event_IHRS_Click(object sender, EventArgs e)
        {
            President_IHRS_Event ihrs_Event = new President_IHRS_Event();
            ihrs_Event.Show();
            this.Hide();
        }
      ...
      Integrated Security=True;Encrypt=False"))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "DELETE FROM dbo.IUBHRS_Member WHERE MemberID = @Id", con);
