...
{
    public partial class Registration_Form_PHSC_2 : Form
    {
        public Registration_Form_PHSC_2()
        {
            InitializeComponent();
        }
        ...
        private void RegistrationPHSC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
                        INSERT INTO PHSC_Event2_Registration
