...
{
    public partial class Volunteer_Form_NYES_2 : Form
    {
        public Volunteer_Form_NYES_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyNYES2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO NYES_Event2_Volunteer
