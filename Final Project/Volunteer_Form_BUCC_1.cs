...
{
    public partial class Volunteer_Form_BUCC_1 : Form
    {
        public Volunteer_Form_BUCC_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyBUCC1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO BUCC_Event1_Volunteer
