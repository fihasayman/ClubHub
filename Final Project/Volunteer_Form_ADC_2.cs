...
{
    public partial class Volunteer_Form_ADC_2 : Form
    {
        public Volunteer_Form_ADC_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyADC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO ADC_Event2_Volunteer
