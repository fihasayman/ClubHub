...
{
    public partial class Activity_NCEC_1 : Form
    {
        public Activity_NCEC_1()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_NCEC_1 volunteer_NCEC_1 = new Volunteer_NCEC_1();
            volunteer_NCEC_1.Show();
            this.Hide();
        }
        ...
        private void Activity_NCEC_1_Load(object sender, EventArgs e)
        {
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM NCEC_Event1_Registration", con);
