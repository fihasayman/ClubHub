...
{
    public partial class President_YES_App : Form
    {
        public President_YES_App()
        {
            InitializeComponent();
        }
        ...
        private void Member_NYES_Click(object sender, EventArgs e)
        {
            President_YES_Mem president_YES_Mem = new President_YES_Mem();
            president_YES_Mem.Show();
            this.Hide();
        }
        ...
        private void Event_NYES_Click(object sender, EventArgs e)
        {
