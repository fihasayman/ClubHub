...
{
    public partial class Activity_ROBU_1 : Form
    {
        public Activity_ROBU_1()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_ROBU_1 volunteer_ROBU_1 = new Volunteer_ROBU_1();
            volunteer_ROBU_1.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM ROBU_Event1_Registration", con);
