...
{
    public partial class Volunteer_Form_IMA_2 : Form
    {
        public Volunteer_Form_IMA_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyIMA2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO IMA_Event2_Volunteer
