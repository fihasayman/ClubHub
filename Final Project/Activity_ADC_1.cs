...
{
    public partial class Activity_ADC_1 : Form
    {
        public Activity_ADC_1()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_ADC_1 volunteer_ADC_1 = new Volunteer_ADC_1();
            volunteer_ADC_1.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM ADC_Event1_Registration", con);
