...
{
    public partial class Volunteer_Form_NYES_1 : Form
    {
        public Volunteer_Form_NYES_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyNYES1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO NYES_Event1_Volunteer
