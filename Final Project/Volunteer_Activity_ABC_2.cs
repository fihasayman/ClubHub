...
{
    public partial class Volunteer_Activity_ABC_2 : Form
    {
        public Volunteer_Activity_ABC_2()
        {
            InitializeComponent();
        }
        ...
        {
            Activity_ABC_2 activity_ABC2 = new Activity_ABC_2();
            activity_ABC2.Show();
            this.Hide();
        }
