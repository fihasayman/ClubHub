...
{
    public partial class Volunteer_Form_ACC_2 : Form
    {
        public Volunteer_Form_ACC_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyACC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO ACC_Event2_Volunteer
