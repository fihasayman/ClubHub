...
{
    public partial class Activity_IHRS_2 : Form
    {
        public Activity_IHRS_2()
        {
            InitializeComponent();
        }

        private void Volunteer_Registration12_Click(object sender, EventArgs e)
        {
            Volunteer_IHRS_2 volunteer_IHRS_2 = new Volunteer_IHRS_2();
            volunteer_IHRS_2.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM IHRS_Event2_Registration", con);
