...
{
    public partial class Volunteer_Form_BUCC_2 : Form
    {
        public Volunteer_Form_BUCC_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyBUCC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO BUCC_Event2_Volunteer
