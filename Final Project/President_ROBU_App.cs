...
{
    public partial class President_ROBU_App : Form
    {
        public President_ROBU_App()
        {
            InitializeComponent();
        }
       ...
       @"Data Source=DESKTOP-IILFUCP\SQLEXPRESS;
          ...
          Integrated Security=True;Encrypt=False"))
            {
                string query = @"
SELECT ApplicantID, FirstName, LastName, Email, Phone, StudentID, Department, Gender, Status, IsActive
FROM BracRobu_Applicants
WHERE IsActive = 1";
          ...
          Integrated Security=True;Encrypt=False"))
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        string insertQuery = @"
                INSERT INTO BracRobu_Member 
                (ApplicantID, FirstName, LastName, Email, Phone, StudentID, Department, Gender)
                SELECT ApplicantID, FirstName, LastName, Email, Phone, StudentID, Department, Gender
                FROM BracRobu_Applicants
                WHERE ApplicantID = @id";
