...
{
    public partial class Volunteer_Form_ABC_2 : Form
    {
        public Volunteer_Form_ABC_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyABC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO ABC_Event2_Volunteer
