...
{
    public partial class Activity_ACC_3 : Form
    {
        public Activity_ACC_3()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_Activity_ACC_3 volunteer_Activity_ACC_3 = new Volunteer_Activity_ACC_3();
            volunteer_Activity_ACC_3.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM ACC_Event3_Registration", con);
