...
{
    public partial class President_YES_Mem : Form
    {
        public President_YES_Mem()
        {
            InitializeComponent();
        }
        ...
        {
            President_YES_App applicant = new President_YES_App();
            applicant.Show();
            this.Hide();
        }
        ...
        {
            President_YES_Event Event = new President_YES_Event();
            Event.Show();
            this.Hide();
        }
        ...
        private void Remove_Mem_Click(object sender, EventArgs e)
        {
            ...
            int memberId = Convert.ToInt32(
                GridViewMem.SelectedRows[0].Cells["MemberID"].Value);
          ...
          Integrated Security=True;Encrypt=False"))
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "DELETE FROM dbo.NSUYES_Member WHERE MemberID = @Id", con);
