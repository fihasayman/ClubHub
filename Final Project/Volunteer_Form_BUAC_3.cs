...
{
    public partial class Volunteer_Form_BUAC_3 : Form
    {
        public Volunteer_Form_BUAC_3()
        {
            InitializeComponent();
        }
        ...
        private void ApplyBUAC3_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO BUAC_Event3_Volunteer
