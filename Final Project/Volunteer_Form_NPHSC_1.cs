...
{
    public partial class Volunteer_Form_NPHSC_1 : Form
    {
        public Volunteer_Form_NPHSC_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyNPHSC1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO NPHSC_Event1_Volunteer
