...
{
    public partial class Volunteer_Form_NCEC_2 : Form
    {
        public Volunteer_Form_NCEC_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyNCEC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO NCEC_Event2_Volunteer
