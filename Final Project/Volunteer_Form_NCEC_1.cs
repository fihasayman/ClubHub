...
{
    public partial class Volunteer_Form_NCEC_1 : Form
    {
        public Volunteer_Form_NCEC_1()
        {
            InitializeComponent();
        }
        ...
        private void ApplyNCEC1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO NCEC_Event1_Volunteer
