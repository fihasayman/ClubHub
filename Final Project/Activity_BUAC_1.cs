...
{
    public partial class Activity_BUAC_1 : Form
    {
        public Activity_BUAC_1()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_BUAC_1 volunteer_BUAC_1 = new Volunteer_BUAC_1();
            volunteer_BUAC_1.Show();
            this.Hide();
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM BUAC_Event1_Registration", con);
