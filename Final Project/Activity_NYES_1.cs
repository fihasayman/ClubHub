...
{
    public partial class Activity_NYES_1 : Form
    {
        public Activity_NYES_1()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_YES_1 volunteer_YES_1 = new Volunteer_YES_1();
            volunteer_YES_1.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM NYES_Event1_Registration", con);
