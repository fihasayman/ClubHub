...
{
    public partial class Volunteer_Form_BUAC_2 : Form
    {
        public Volunteer_Form_BUAC_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyBUAC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO BAUC_Event2_Volunteer
