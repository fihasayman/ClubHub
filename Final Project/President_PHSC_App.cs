...
{
    public partial class President_PHSC_App : Form
    {
        public President_PHSC_App()
        {
            InitializeComponent();
        }

        private void Member_NPHSC_Click(object sender, EventArgs e)
        {
        ...
        private void Event_NPHSC_Click(object sender, EventArgs e)
        {
