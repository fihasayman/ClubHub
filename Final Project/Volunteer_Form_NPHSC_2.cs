...
{
    public partial class Volunteer_Form_NPHSC_2 : Form
    {
        public Volunteer_Form_NPHSC_2()
        {
            InitializeComponent();
        }
        ...
        private void ApplyNPHSC2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO NPHSC_Event2_Volunteer
