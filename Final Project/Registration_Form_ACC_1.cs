...
{
    public partial class Registration_Form_ACC_1 : Form
    {
        public Registration_Form_ACC_1()
        {
            InitializeComponent();
        }
        ...
        private void RegistrationACC1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
                        INSERT INTO ACC_Event1_Registration
        ...
        private void Registration_Form_ACC_1_Load(object sender, EventArgs e)
        {
