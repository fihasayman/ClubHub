...
{
    public partial class Volunteer_Form_IHRS_3 : Form
    {
        public Volunteer_Form_IHRS_3()
        {
            InitializeComponent();
        }
        ...
        private void ApplyIHRS3_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = @"
            INSERT INTO IHRS_Event3_Volunteer
