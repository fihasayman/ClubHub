...
{
    public partial class Activity_ADC_2 : Form
    {
        public Activity_ADC_2()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_ADC_2 volunteer_ADC_2 = new Volunteer_ADC_2();
            volunteer_ADC_2.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM ADC_Event2_Registration", con);
