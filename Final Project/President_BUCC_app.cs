...
{
    public partial class President_BUCC_app : Form
    {
        public President_BUCC_app()
        {
            InitializeComponent();
        }
        ...
        {
            President_BUCC_Event president_BUCC_ = new President_BUCC_Event();
            president_BUCC_.Show();
            this.Hide();
        }
...
WHERE IsActive = 1";
        ...
        private void Reject_Click(object sender, EventArgs e)
        {
            ...
            else if (university == "BRAC")
            {
                ...
                else if (club == "BUCC") tableName = "BracCC_Applicants";
