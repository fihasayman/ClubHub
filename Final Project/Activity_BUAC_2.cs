...
{
    public partial class Activity_BUAC_2 : Form
    {
        public Activity_BUAC_2()
        {
            InitializeComponent();
        }
        ...
        {
            Volunteer_BUAC_2 volunteer_BUAC2 = new Volunteer_BUAC_2();
            volunteer_BUAC2.Show();
            this.Hide();
        }
          ...
          Integrated Security=True;Encrypt=False"))
            {
              ...
              FROM BUAC_Event2_Registration", con);
